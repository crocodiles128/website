        ...
        <div>
            <div data-draggable="true" class="" style="position: relative;" draggable="false"><!----><!---->
                <section draggable="false" class="overflow-hidden pt-0" data-v-271253ee="">
                    <section class="mb-10"> <!-- Background image -->
                        <div class="p-5 text-center bg-image"
                            style="background-image: url(&quot;https://mdbootstrap.com/img/new/textures/full/142.jpg&quot;); height: 500px; background-size: cover; background-position: 50% 50%; background-color: rgba(0, 0, 0, 0);"
                            aria-controls="#picker-editor"></div> <!-- Background image -->
                        <div class="container">
                            <div class="card mx-4 mx-md-5 text-center shadow-5-strong"
                                ...
                                <div class="card-body px-4 py-5 px-md-5">
                                    <h1 class="display-3 fw-bold ls-tight mb-4"> <span>Textura Oficial do
                                            servidor</span> <br> <span class="text-primary"></span> </h1> <a
                                        href="imgs/textura.zip" download="§2CROCODILÂNDIA§6§lpack"
                                        class="btn btn-primary stretched-link">Download<i
                                            class="fas fa-download p-1 ps-2"></i></a>
                                    <h1 class="display-3 fw-bold ls-tight mb-4"> <span>World da V3.0</span> <br> <span
                                            class="text-primary"></span> </h1> <a href="imgs/worldv3.zip"
                                        download="World V.3" class="btn btn-primary stretched-link">World<i
                                            class="fas fa-download p-1 ps-2"></i></a>
                                </div>
                            </div>
                        </div>
